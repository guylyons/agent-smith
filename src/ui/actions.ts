...
type Result = { ok: boolean; error?: string; cardId?: string; existing?: boolean; path?: string; url?: string; cancelled?: boolean; branch?: string; base?: string; delivery?: Delivery[] };
